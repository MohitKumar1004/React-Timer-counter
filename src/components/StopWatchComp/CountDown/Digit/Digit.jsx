...
const Digit = (props) => {
  ...
  return (
    <div className='digit mx-3 text-center justify-content-center align-items-center lh-1' style={{backgroundImage:`linear-gradient(white,${props.color},black,${props.color},white)`,filter:`drop-shadow(10px 10px 10px ${props.color})`}}>
